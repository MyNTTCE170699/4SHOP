    ...
    <body>
        ...
        <!--        <div class="container-fluid" style="margin-top: 56px">
                    <form method="post" enctype="multipart/form-data" action="/product">
                        ...
                        ImgURL: <input type="file" name="productImg">
                        <input type="submit" name="btnAddnew" value="Add New"> <br>
                    </form>
                </div>-->
                            ...
                            <div class="card-body p-4 p-md-5">
                                <form method="post" enctype="multipart/form-data" action="/product" id="productForm">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input required type="number" pattern="^(0|[1-9]\d{0,2})(\.\d{2})?$" name="productPrice" class="form-control" />
                                    </div>
